...
tags: ["google", "gemini", "gemini-1-5", "system-prompt", "llm-instruction"]
category: "System_Prompts"
subcategory: "Llm_Instructions"
---

# Google Gemini 1.5 System Prompt

## Purpose
Provides the system instructions for Google's Gemini 1.5 model, setting guidelines for interactions, knowledge cutoff, and safe usage.
