...
tags: ["notion", "system-prompt", "ai-assistant"]
...
## Purpose
System prompt for Notion AI assistant to understand Notion-specific workflow surfaces for pages, databases, notifications, agents, and triggers.
...
## Output Format
Follow the instructions provided within the Notion AI system prompt.
