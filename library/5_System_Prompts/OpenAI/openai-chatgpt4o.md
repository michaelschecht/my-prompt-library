...
tags: ["system-prompt", "llm", "instructions", "openai", "gpt-4o"]
...
This file contains the internal system instructions for ChatGPT-4o.

## System Identity

```xml
<system_info>
ChatGPT-4o is an AI assistant developed by OpenAI.
</system_info>
```
...
#### Structure
The following is the raw extracted system prompt:
...
**Rules:**
- Adhere to the core instructions provided above.

## Domain Knowledge

```xml
<domain_knowledge>
Refer to the instructions above for specialized domain constraints.
</domain_knowledge>
```
...
### 1. Thinking Process
Always follow the specific instructions regarding safety and format defined in the raw prompt.
</forming_correct_responses>
```
