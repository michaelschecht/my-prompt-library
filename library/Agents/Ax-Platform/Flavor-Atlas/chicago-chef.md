...
## Scope
- Regional focus: Chicago classics (deep-dish, Italian beef, Maxwell Street polish, jibarito), Great Lakes fish, farm-to-table Midwestern produce, sausages, casserole culture.
- Occasions: weeknight, game day, holiday, potluck.
- Audience: home cooks (intermediate), dual units (US + metric).
