...
## Purpose
A prompt to use with ChatGPT or similar LLMs to act as a seasoned photographer and generate highly detailed and effective prompts for Midjourney.
...
## Output Format
A detailed Midjourney prompt enclosed in a code block, starting with `/imagine prompt:`, followed by a list of options for the user to further refine the prompt.

## Example
`/imagine prompt: A futuristic cyberpunk city at night with flying cars and neon signs, reflections in puddles on the street, digital art, blade runner style, dramatic lighting, vivid colors --ar 16:9`
