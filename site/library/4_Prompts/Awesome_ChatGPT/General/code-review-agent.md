...
tags: ["awesome-chatgpt", "code", "review", "agent"]
...
Contributed by [@fanxiangs](https://github.com/fanxiangs) to [f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts).
