...
tags: ["v0", "vercel", "ai", "coding", "assistant"]
...
## Purpose
System prompt for v0, Vercel's AI-powered assistant, optimized for generating Next.js applications and React components.
...
## Output Format
Follow the formatting and code structure instructions defined in the prompt above. Use MDX format and <CodeProject> to group files for Next.js apps.

## Example
**Input:**
Create a simple login form with shadcn/ui.

**Output:**
[Expected response following the system prompt guidelines, utilizing Next.js, shadcn/ui, and Tailwind CSS.]
