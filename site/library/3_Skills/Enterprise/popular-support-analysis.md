...
tags: ["skill", "enterprise", "popular-support-analysis"]
category: "Skills"
...
1. **Contented (安)** - People feel secure, basic needs met, treated fairly
   - Result: Stability, support for government
   - Rebellion risk: Low

2. **Endangered (危)** - People feel threatened, impoverished, oppressed
...
## Application
1. Evaluate the people's condition using indicators above
2. If endangered, implement relief measures immediately
3. Understand that even weak leaders can spark successful rebellion when people are desperate
